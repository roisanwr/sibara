<?php
// transaksi/transaksi-detail.php

include '../auth_check.php';
include '../koneksi.php';

if (!isset($_GET['id'])) {
    header('Location: transaksi-lihat.php');
    exit;
}
...
if (!$transaksi) {
    header('Location: transaksi-lihat.php'); exit;
}

// Ambil detail barang yang terlibat
...
<main class="flex-1 p-4 lg:p-8">
    <div class="stat-card p-6 rounded-xl soft-shadow">
        ...
        <div class="overflow-x-auto">
         ...
         <div class="mt-8">
            <a href="transaksi-lihat.php" class="text-sm font-medium text-indigo-600 hover:text-indigo-800">← Kembali ke Riwayat Transaksi</a>
        </div>
    </div>
</main>

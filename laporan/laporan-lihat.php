...
// Query untuk mengambil data permintaan berdasarkan rentang tanggal
...
<main class="flex-1 p-4 lg:p-8">
    <div class="stat-card p-6 rounded-xl soft-shadow">
        ...
        <!-- Form Filter Tanggal -->
        <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end mb-8 pb-6 border-b" style="border-color: var(--border-color);">
            <div>
            ...
            <div class="flex gap-4">
                <button type="submit" class="w-full bg-orange-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">Tampilkan</button>
                <a href="laporan-cetak.php?tgl_awal=<?php echo $tgl_awal; ?>&tgl_akhir=<?php echo $tgl_akhir; ?>" target="_blank" class="w-full text-center bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-lg">Cetak</a>
            </div>
        </form>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y" style="border-color: var(--border-color);">
                ...
                <tbody class="divide-y" style="background-color: var(--bg-card); border-color: var(--border-color);">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-center text-sm" style="color: var(--text-muted);">
                                Tidak ada data permintaan untuk periode yang dipilih.
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
